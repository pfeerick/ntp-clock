...
void setup() {
  ...
  DebugPrint("Compiled: " __DATE__ ", " __TIME__ ", Arduino IDE v"); DebugPrintln(ARDUINO,DEC); 
  DebugPrint(F("Core version: ")); DebugPrintln(ESP.getCoreVersion());
  DebugPrint(F("SDK version: ")); DebugPrintln(ESP.getSdkVersion());
  DebugPrint(F("Chip ID: ")); DebugPrintln(ESP.getChipId());
  DebugPrint(F("Reset reason: ")); DebugPrintln(ESP.getResetReason());
  DebugPrint(F("Heap free: ")); DebugPrintln(ESP.getFreeHeap());
  DebugPrintln("");
